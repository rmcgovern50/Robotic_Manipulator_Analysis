calc_A_D MATLAB Python Package
...
2. Installing the calc_A_D Package

A. Change to the directory that contains the file setup.py and the subdirectory calc_A_D. 
...
3. Using the calc_A_D Package

The calc_A_D package is on your Python path. To import it into a Python script or 
session, execute:
