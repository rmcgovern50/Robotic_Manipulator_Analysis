...
def plot_torques(torques_list):
    
    N = np.linspace(0, 1, num=len(torques_list))
    
    tau1 = [x[0] for x in torques_list]
    tau2 = [x[1] for x in torques_list]
    tau3 = [x[2] for x in torques_list]
    tau4 = [x[3] for x in torques_list]
    tau5 = [x[4] for x in torques_list]
    tau6 = [x[5] for x in torques_list]
    
    #print("data ", len(N), len(tau1))
    plt.plot(N, tau1, label="$\\tau_1$")
    plt.plot(N, tau2, label='$\\tau_2$')
    plt.plot(N, tau3, label='$\\tau_3$')
    plt.plot(N, tau4, label='$\\tau_4$')
    plt.plot(N, tau5, label='$\\tau_5$')
    plt.plot(N, tau6, label='$\\tau_6$')
...
def plot_joint_list(q_list):
    
    N = np.linspace(0, 1, num=len(q_list))
    
    tau1 = [x[0] for x in q_list]
    tau2 = [x[1] for x in q_list]
    tau3 = [x[2] for x in q_list]
    tau4 = [x[3] for x in q_list]
    tau5 = [x[4] for x in q_list]
    tau6 = [x[5] for x in q_list]
    
    #print("data ", len(N), len(tau1))
    plt.plot(N, tau1, label="$q_1$")
    plt.plot(N, tau2, label='$q_2$')
    plt.plot(N, tau3, label='$q_3$')
    plt.plot(N, tau4, label='$q_4$')
    plt.plot(N, tau5, label='$q_5$')
    plt.plot(N, tau6, label='$q_6$')
